...
export const els = {
  ...
  confirmExitOverlay:  document.getElementById("confirmExitOverlay"),
  confirmResumeBtn:    document.getElementById("confirmResumeBtn"),
  confirmAbandonBtn:   document.getElementById("confirmAbandonBtn"),
